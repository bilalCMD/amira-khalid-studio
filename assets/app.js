(function(){
  ...
  var translations = {
    ar: {
      ...
      "contact.infoDistrictAddr":"الرحمانية، جدة 23765",
      ...
      "journal.art9.tag":"دليل الأسعار","journal.art9.title":"دليلكِ الشامل لأسعار مكياج العروس في جدة",
      "journal.art9.excerpt":"من أكثر الأسئلة التي تصلني: بكم مكياج العروس عندك؟ إليكِ شرح واضح لكيفية حساب الأسعار لتخططي لميزانية يومكِ بثقة.",
      "journal.art9.body":"<p>من أكثر الأسئلة التي تصلني: \"بكم مكياج العروس عندك؟\" في هذا المقال سأشرح لكِ بوضوح كيف تُحسب الأسعار، وما الذي يؤثر عليها، لتخططي لميزانية يومكِ بثقة.</p><h2>مم تتكون تكلفة مكياج العروس؟</h2><p>السعر الأساسي يشمل المكياج الاحترافي والرموش، لكن باقة العروس الكاملة تضيف تسريحة الشعر وجلسة تألق الجسم. كل عنصر إضافي يُحتسب بشفافية ضمن الباقة، بدون مفاجآت في يوم الحجز.</p><h2>هل تختلف الأسعار بين الاستوديو والخدمة الخارجية؟</h2><p>الأسعار المعلنة تشمل التنقل داخل جدة عند الحجز للخدمة الخارجية. أما خارج جدة، فتُضاف رسوم تنقل بسيطة تُحدد عند التواصل، حسب المسافة.</p><h2>متى يُفضّل حجز جلسة التجربة؟</h2><p>ننصح بجلسة تجربة قبل يوم الزفاف بثلاثة إلى أربعة أسابيع على الأقل، لضمان تعديل أي تفصيل بهدوء بعيدًا عن ضغط يوم المناسبة.</p><p>لمعرفة الأسعار الحالية بالتفصيل، تصفحي <a href=\"pricing\">صفحة الأسعار</a>، أو تواصلي معنا مباشرة عبر واتساب لأي استفسار.</p>",
      "journal.art10.tag":"مواسم","journal.art10.title":"مكياج العيد: أفكار وإطلالات لموسم الأعياد",
      "journal.art10.excerpt":"موسم العيد من أكثر الأوقات التي تحتاجين فيها إطلالة تجمع بين البهجة والأناقة. إليكِ أفكارًا تساعدكِ على اختيار مكياج العيد المناسب.",
      "journal.art10.body":"<p>موسم العيد من أكثر الأوقات التي تحتاجين فيها إطلالة تجمع بين البهجة والأناقة. إليكِ أفكارًا تساعدكِ على اختيار مكياج العيد المناسب لكِ هذا الموسم.</p><h2>إطلالة نهارية مشرقة لصلاة العيد والزيارات</h2><p>للنهار، أنصح بمكياج خفيف يبرز إشراقة البشرة مع لمسة بسيطة من الألوان الدافئة على الخدين والشفاه — إطلالة أنيقة تدوم طوال النهار دون ثقل.</p><h2>إطلالة مسائية جريئة للسهرات العائلية</h2><p>مع اقتراب المساء، يمكن تكثيف مكياج العيون بظلال ذهبية أو نحاسية، مع أحمر شفاه أغمق قليلًا، لإطلالة تناسب أجواء السهرة دون مبالغة.</p><h2>لا تنسي تجهيز بشرتكِ قبل يوم العيد</h2><p>ابدئي بترطيب بشرتكِ جيدًا قبل أيام من العيد لضمان ثبات أفضل للمكياج. <a href=\"journal-skin-prep\">اقرئي دليلنا الكامل لتجهيز البشرة →</a></p><p>إذا رغبتِ بحجز موعد لإطلالة العيد، تواصلي معنا مبكرًا فالمواعيد تُحجز بسرعة خلال هذا الموسم.</p>",
      "journal.art11.tag":"مناسبات","journal.art11.title":"مكياج الخطوبة: كيف يختلف عن مكياج يوم الزفاف",
      "journal.art11.excerpt":"الخطوبة مناسبة لها طابعها الخاص — أقل رسمية من يوم الزفاف، لكنها لا تقل أهمية. إليكِ كيف يختلف مكياج الخطوبة عن مكياج العروس.",
      "journal.art11.body":"<p>الخطوبة مناسبة لها طابعها الخاص — أقل رسمية من يوم الزفاف، لكنها لا تقل أهمية. إليكِ كيف يختلف مكياج الخطوبة عن مكياج العروس.</p><h2>إطلالة أخف وأقرب لملامحكِ الطبيعية</h2><p>عادة ما يكون مكياج الخطوبة أخف من مكياج الزفاف، مع تركيز أكبر على إبراز نضارة البشرة وملامحكِ الطبيعية بدلًا من طبقات المكياج الثقيلة.</p><h2>مساحة أكبر للتجربة والألوان الجريئة</h2><p>بما أن الخطوبة ليست يوم الزفاف نفسه، يمكنكِ تجربة ألوان أو أساليب جديدة — مثل ظلال ملونة أو أحمر شفاه جريء — لتستكشفي ما يناسبكِ قبل اتخاذ القرار النهائي ليوم الزفاف.</p><h2>تنسيق يتماشى مع فستان الخطوبة</h2><p>نناقش معًا لون وتصميم فستان الخطوبة قبل الجلسة، لضمان تناسق المكياج والتسريحة مع الإطلالة الكاملة.</p><p>مهما كان أسلوب خطوبتكِ، أنا هنا لمساعدتكِ في إيجاد الإطلالة التي تشعركِ بأجمل نسخة من نفسكِ. <a href=\"contact\">احجزي موعدكِ</a> اليوم.</p>",
      "journal.art12.tag":"نصائح محلية","journal.art12.title":"لماذا يدوم مكياجكِ أطول في مناخ جدة؟",
      "journal.art12.excerpt":"جدة معروفة برطوبتها العالية، وهذا يطرح تحديًا حقيقيًا لثبات المكياج. إليكِ كيف أتعامل مع هذا التحدي لضمان إطلالة تدوم طوال مناسبتكِ.",
      "journal.art12.body":"<p>جدة معروفة برطوبتها العالية، وهذا يطرح تحديًا حقيقيًا لثبات المكياج. إليكِ كيف أتعامل مع هذا التحدي لضمان إطلالة تدوم طوال مناسبتكِ.</p><h2>لماذا تؤثر الرطوبة على ثبات المكياج؟</h2><p>الرطوبة العالية تزيد من إفراز الزيوت الطبيعية للبشرة، ما قد يجعل المكياج التقليدي ينزلق أو يفقد إشراقته بسرعة أكبر من المناخ الجاف.</p><h2>منتجات وتقنيات مقاومة للرطوبة</h2><p>أعتمد على منتجات عالمية مصممة خصيصًا للثبات الطويل، مع تقنيات تحضير بشرة تشمل طبقات خفيفة من البرايمر ورذاذ التثبيت، لضمان مكياج يصمد لساعات دون الحاجة لتعديل متكرر.</p><h2>نصيحة لتجهيز بشرتكِ في مناخ جدة</h2><p>تجنبي الكريمات الثقيلة قبل الجلسة، واحرصي على تنظيف بشرتكِ جيدًا. <a href=\"journal-makeup-last-longer\">اقرئي المزيد من نصائحنا لإطالة عمر المكياج →</a></p><p>سواء كانت مناسبتكِ في الصباح أو تمتد حتى ساعات متأخرة من الليل، أضمن لكِ إطلالة تبقى مشرقة من البداية للنهاية.</p>",
    ...
    en: {
      ...
      "contact.infoDistrictAddr":"Ar Rohmaniyah District, Jeddah 23765",
      ...
      "journal.art9.tag":"Pricing Guide","journal.art9.title":"Your Complete Guide to Bridal Makeup Prices in Jeddah",
      "journal.art9.excerpt":"One of the questions I get most often: how much is bridal makeup? Here's a clear breakdown of how pricing works, so you can plan your big-day budget with confidence.",
      "journal.art9.body":"<p>One of the questions I get most often: \"How much is bridal makeup?\" In this article I'll walk you through exactly how pricing works, so you can plan your big-day budget with confidence.</p><h2>What Makes Up the Cost of Bridal Makeup?</h2><p>The base price covers professional makeup and lashes, while the full Bridal Package adds hairstyling and a body glow session. Every add-on is priced transparently upfront — no surprises on booking day.</p><h2>Does the Price Differ Between Studio and At-Home Service?</h2><p>Listed prices already include travel within Jeddah for at-home bookings. For locations outside Jeddah, a small travel fee applies based on distance, confirmed when you reach out.</p><h2>When Should You Book a Trial Session?</h2><p>I recommend booking a trial three to four weeks before the wedding at minimum, so we can fine-tune every detail calmly, well away from wedding-day pressure.</p><p>For full current pricing, browse the <a href=\"pricing\">pricing page</a>, or reach out directly on WhatsApp with any questions.</p>",
      "journal.art10.tag":"Seasonal","journal.art10.title":"Eid Makeup: Ideas and Looks for the Season",
      "journal.art10.excerpt":"Eid season is one of those times you want a look that balances joy and elegance. Here are a few ideas to help you choose the right Eid makeup for this season.",
      "journal.art10.body":"<p>Eid season is one of those times you want a look that balances joy and elegance. Here are a few ideas to help you choose the right Eid makeup for this season.</p><h2>A Bright Daytime Look for Prayers and Visits</h2><p>For daytime, I recommend light makeup that lets your skin glow, with a soft touch of warm color on the cheeks and lips — an elegant look that lasts all day without feeling heavy.</p><h2>A Bolder Evening Look for Family Gatherings</h2><p>As evening approaches, eye makeup can be intensified with gold or copper tones, paired with a slightly deeper lip color, for a look suited to the evening's atmosphere without going overboard.</p><h2>Don't Forget to Prep Your Skin Before Eid</h2><p>Start moisturizing your skin well a few days before Eid to ensure your makeup lasts better. <a href=\"journal-skin-prep\">Read our full skin prep guide →</a></p><p>If you'd like to book an Eid look, reach out early — appointments fill up fast during this season.</p>",
      "journal.art11.tag":"Occasions","journal.art11.title":"Engagement Makeup: How It Differs From Your Wedding Day Look",
      "journal.art11.excerpt":"An engagement has its own character — less formal than the wedding day, but no less important. Here's how engagement makeup differs from bridal makeup.",
      "journal.art11.body":"<p>An engagement has its own character — less formal than the wedding day, but no less important. Here's how engagement makeup differs from bridal makeup.</p><h2>A Lighter Look, Closer to Your Natural Features</h2><p>Engagement makeup is usually lighter than bridal makeup, with more focus on fresh, radiant skin and your natural features rather than heavy layers of product.</p><h2>More Room to Experiment With Bold Colors</h2><p>Since the engagement isn't the wedding day itself, it's a great chance to try new colors or styles — like colored eyeshadow or a bold lip — to explore what suits you before deciding on your final wedding-day look.</p><h2>Coordinated With Your Engagement Dress</h2><p>We discuss your engagement dress color and style together before the session, to make sure your makeup and hair complement the full look.</p><p>Whatever style you're going for, I'm here to help you find the look that makes you feel like the most beautiful version of yourself. <a href=\"contact\">Book your appointment</a> today.</p>",
      "journal.art12.tag":"Local Tips","journal.art12.title":"Why Your Makeup Lasts Longer in Jeddah's Climate",
      "journal.art12.excerpt":"Jeddah is known for its high humidity, which poses a real challenge for makeup longevity. Here's how I handle that challenge to make your look last through your occasion.",
      "journal.art12.body":"<p>Jeddah is known for its high humidity, which poses a real challenge for makeup longevity. Here's how I handle that challenge to make sure your look lasts through your entire occasion.</p><h2>Why Does Humidity Affect Makeup Longevity?</h2><p>High humidity increases the skin's natural oil production, which can make conventional makeup slip or lose its finish faster than in a drier climate.</p><h2>Humidity-Resistant Products and Techniques</h2><p>I rely on international products specifically designed for long wear, combined with skin-prep techniques — light layers of primer and setting spray — to ensure makeup holds up for hours without constant touch-ups.</p><h2>A Tip for Prepping Your Skin in Jeddah's Climate</h2><p>Avoid heavy creams before your session, and make sure your skin is thoroughly cleansed. <a href=\"journal-makeup-last-longer\">Read more of our tips for longer-lasting makeup →</a></p><p>Whether your occasion is in the morning or runs late into the night, I guarantee a look that stays radiant from start to finish.</p>",
