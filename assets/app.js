(function(){
  ...
  var translations = {
    ar: {
      ...
      "hero.badge1":"+500 عروس وعميلة","hero.badge2":"تعقيم 100% للأدوات","hero.badge3":"عبدالمغيث الحربي، جدة",
      ...
      "cta.check1":"تأكيد سريع عبر واتساب","cta.check2":"خدمة منزلية متوفرة لباقة العروس","cta.check3":"منتجات عالمية أصلية","cta.check4":"تعقيم 100% للأدوات",
      ...
      "faq.q9":"أين يقع استوديو أميرة خالد بالضبط؟","faq.a9":"الاستوديو في عبدالمغيث الحربي، جدة. لباقة العروس، نوفر أيضًا خدمة المكياج في موقعكِ.",
      ...
      "about.feat1":"منتجات عالمية احترافية","about.feat2":"تعقيم كامل وأدوات فردية لكل عميلة","about.feat3":"في استوديو أميرة، عبدالمغيث الحربي، جدة","about.feat4":"تجربة راقية من الحجز إلى التنفيذ",
      "about.trustLine":"من أكثر خبيرات المكياج ثقة لدى عرائس جدة، بتقييم 4.9 من أكثر من 500 عروس وعميلة.",
      "about.areasServed":"لباقة العروس، نغطي معظم أحياء جدة: الشاطئ، الروضة، النعيم، السلامة، الحمراء، الأندلس وغيرها.",
      ...
      "pricing.homeStudioNote":"* الخدمات تُقدَّم بموعد مسبق في استوديو أميرة، عبدالمغيث الحربي، جدة. باقة العروس فقط متوفرة أيضًا في موقعكِ بجدة (قد تُضاف رسوم تنقل).","pricing.priceOnRequest":"السعر عند التواصل",
      ...
      "footer.areasServed":"لباقة العروس، نغطي معظم أحياء جدة: الشاطئ، الروضة، النعيم، السلامة، الحمراء، الأندلس وغيرها.",
      ...
      "policy.homeStudioTitle":"استوديو أميرة في عبدالمغيث الحربي","policy.homeStudioDesc":"تُقدَّم الخدمات بموعد مسبق في استوديو أميرة المجهز بالكامل في عبدالمغيث الحربي، جدة. باقة العروس فقط متوفرة أيضًا في موقعكِ بجدة.",
    ...
    en: {
      ...
      "hero.badge1":"500+ Brides & Clients","hero.badge2":"100% Tool Sterilization","hero.badge3":"Abdul Mughith Al Harbi, Jeddah",
      ...
      "cta.check1":"Fast WhatsApp confirmation","cta.check2":"At-home service available for the Bridal Package","cta.check3":"Genuine international products","cta.check4":"100% tool sterilization",
      ...
      "faq.q9":"Where exactly is Amira Khalid Studio located?","faq.a9":"Our studio is in Abdul Mughith Al Harbi, Jeddah. For the Bridal Package, we also offer makeup service at your location.",
      ...
      "about.feat1":"Professional international brands","about.feat2":"Full sterilization & single-use tools per client","about.feat3":"At Amira's studio in Abdul Mughith Al Harbi, Jeddah","about.feat4":"A refined experience from booking to execution",
      "about.trustLine":"One of Jeddah's most trusted names in bridal makeup, rated 4.9★ by 500+ brides and clients.",
      "about.areasServed":"For the Bridal Package, we cover most Jeddah districts: Al-Shatie, Al-Rawdah, Al-Naeem, Al-Salamah, Al-Hamra, Al-Andalus, and more.",
      ...
      "pricing.homeStudioNote":"* Services are by appointment at Amira's studio in Abdul Mughith Al Harbi, Jeddah. Only the Bridal Package is also available at your location in Jeddah (travel fees may apply).","pricing.priceOnRequest":"Price on request",
      ...
      "footer.areasServed":"For the Bridal Package, we cover most Jeddah districts: Al-Shatie, Al-Rawdah, Al-Naeem, Al-Salamah, Al-Hamra, Al-Andalus, and more.",
      ...
      "policy.homeStudioTitle":"Amira's Studio in Abdul Mughith Al Harbi","policy.homeStudioDesc":"Services are provided by appointment at Amira's fully equipped studio in Abdul Mughith Al Harbi, Jeddah. Only the Bridal Package is also available at your location in Jeddah.",
  ...
  var htmlKeys = {"pricing.durationRegular":1,"pricing.durationBride":1,"footer.rights":1,"bookingPreview.step1":1,"bookingPreview.step2":1,"bookingPreview.step3":1,"bookingPreview.step4":1,"contact.policyNote":1,
    ...
    "about.story":1,"about.teaser":1,"philosophy.body":1,
