(function(){
  ...
  var translations = {
    ar: {
      ...
      "reelNew1.caption":"إطلالة عروس ناعمة","reelNew2.caption":"من داخل الجلسة — تفاصيل العين","reelNew3.caption":"لوك سهرة بلمسة درامية","reelNew4.caption":"إطلالة عروس بالدانتيل",
      ...
      "cfaq.eyebrow":"قبل ما تحجزي",
      "cfaq.title":"أسئلة عن الحجز والموقع",
      "cfaq.q1":"أين يقع استوديو أميرة خالد في جدة؟",
      "cfaq.a1":"الاستوديو في حي الرحمانية بجدة — فيلا رقم 8778، الرمز البريدي 23765. جميع الخدمات تُقدَّم داخل الاستوديو بموعد مسبق.",
      "cfaq.q2":"كيف أحجز موعدًا في الاستوديو؟",
      "cfaq.a2":"تتم جميع الحجوزات عبر واتساب مباشرة، حيث نؤكد معكِ الخدمة والتاريخ والوقت قبل تثبيت الموعد.",
      "cfaq.q3":"هل تقدمون خدمة المكياج في المنزل؟",
      "cfaq.a3":"لا، جميع الخدمات تُقدَّم داخل الاستوديو فقط في حي الرحمانية بجدة، بموعد مسبق.",
      "cfaq.q4":"هل يتطلب الحجز دفع عربون؟",
      "cfaq.a4":"نعم، يتطلب تأكيد كل حجز دفع عربون. في حال عدم استلام العربون خلال 24 ساعة من وقت الحجز، يُلغى الحجز تلقائيًا، والعربون غير قابل للاسترداد في حال الإلغاء.",
      "cfaq.q5":"ما هي ساعات عمل الاستوديو؟",
      "cfaq.a5":"من الأحد إلى الأربعاء: 11:00 صباحًا حتى 10:00 مساءً. ومن الخميس إلى السبت: 9:00 صباحًا حتى 11:00 مساءً.",
      "cfaq.q6":"ماذا يحدث إذا تأخرتُ عن موعدي؟",
      "cfaq.a6":"يُرجى الحضور في الموعد المحدد تمامًا. التأخير لأكثر من 15 دقيقة دون إشعار مسبق قد يؤدي لتقليص وقت الجلسة أو إلغائها، حفاظًا على مواعيد بقية العميلات.",
      "cfaq.q7":"هل يمكنني تأجيل موعدي؟",
      "cfaq.a7":"نعم، تواصلي معنا عبر واتساب بأقرب وقت ممكن وسنعمل معكِ لإيجاد موعد بديل مناسب.",
    ...
    en: {
      ...
      "reelNew1.caption":"A soft bridal look","reelNew2.caption":"Inside the session — eye detail","reelNew3.caption":"An evening look with a dramatic touch","reelNew4.caption":"A bridal look in lace",
      ...
      "cfaq.eyebrow":"Before you book",
      "cfaq.title":"Booking and location questions",
      "cfaq.q1":"Where is Amira Khalid Studio in Jeddah?",
      "cfaq.a1":"The studio is in the Al Rahmaniyah district of Jeddah — Villa 8778, postal code 23765. All services are provided inside the studio, by prior appointment.",
      "cfaq.q2":"How do I book an appointment?",
      "cfaq.a2":"All bookings are made directly over WhatsApp, where we confirm the service, the date and the time with you before the appointment is held.",
      "cfaq.q3":"Do you offer makeup at home?",
      "cfaq.a3":"No. All services are provided inside the studio in Al Rahmaniyah, Jeddah, by prior appointment only.",
      "cfaq.q4":"Is a deposit required to book?",
      "cfaq.a4":"Yes. Every booking is confirmed by a deposit. If the deposit is not received within 24 hours of booking, the appointment is released automatically. The deposit is non-refundable if you cancel.",
      "cfaq.q5":"What are the studio's opening hours?",
      "cfaq.a5":"Sunday to Wednesday, 11:00 AM to 10:00 PM. Thursday to Saturday, 9:00 AM to 11:00 PM.",
      "cfaq.q6":"What happens if I arrive late?",
      "cfaq.a6":"Please arrive exactly at your appointment time. Arriving more than 15 minutes late without notice may mean the session is shortened or cancelled, so that the other clients' appointments are not affected.",
      "cfaq.q7":"Can I reschedule my appointment?",
      "cfaq.a7":"Yes. Message us on WhatsApp as early as you can and we will work with you to find another time that suits you.",
